...
int main(int argc, const char * argv[]) {
    ...
    ParticleMoveAlgorithmPtr pParticleMoveAlgorithm = particlesMoveAlgorithmAssembler.createAlgorithmInstance(ParticleMoveAlgorithmAssembler::MULTI_THREAD_BATCH);
