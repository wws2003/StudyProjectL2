...
#include "RequestPostExecutorSendResponseImpl.h"

RequestPostExecutorSendResponseImpl::RequestPostExecutorSendResponseImpl(IResponseProcessorPtr responseProcessorPtr, IResponseSenderFactoryPtr responseSenderFactoryPtr) : m_pResponseProcessor(responseProcessorPtr), m_pResponseSenderFactory(responseSenderFactoryPtr){
    
}

bool RequestPostExecutorSendResponseImpl::onRequestExecutionEnd(ResponsePtr responsePtr) {
